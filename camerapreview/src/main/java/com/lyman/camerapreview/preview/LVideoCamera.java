...
public class LVideoCamera {
	private static final String TAG = "LVideoCamera";
	...
	public LVideoCamera(Context context) {
...
//			parameters.setRecordingHint(true);
	...
	private LVideoCameraCallback mCallback;

	public interface LVideoCameraCallback {
		public void onPermissionDismiss(String tip);
		
		public void notifyFrameAvailable();
	}

	public void setCallback(LVideoCameraCallback callback) {
